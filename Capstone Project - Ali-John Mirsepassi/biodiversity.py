...
category_pivot['percent_protected'] = 1.0 * (category_pivot.protected) /(category_pivot.protected + category_pivot.not_protected)
...
bryce_weeks = np.ceil(sample_size / 250)
yellowstone_weeks = np.ceil(sample_size/507)
